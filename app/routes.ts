...
export default [
    ...
    route("event/:slug/edit", "routes/event-edit.tsx"),
    ...
    route("entity/:slug/edit", "routes/entity-edit.tsx"),
    route("entity/create", "routes/entity-create.tsx"),
    route("series", "routes/series.tsx"),
    route("series/:slug", "routes/series-detail.tsx"),
    route("series/:slug/edit", "routes/series-edit.tsx"),
    route("series/create", "routes/series-create.tsx"),
    route("tags/create", "routes/tag-create.tsx"),
    route("tags/:slug/edit", "routes/tag-edit.tsx"),
